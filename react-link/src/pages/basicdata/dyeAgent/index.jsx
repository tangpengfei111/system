...
export default function (props) {
    ...
    const columns = [
        { title: "染化剂编号", dataIndex: 'no', align: 'center' },
        { title: "染化剂名称", dataIndex: 'name', align: 'center' },
    ...
    /*
     * FunctionName: 获取可用供应商列表
     * Author: 唐鹏飞
     * Description: 
     */
    async function getAvailableSupplier() {
        let result = await dispatch({
            type: 'common/fetchData',
            apiKey: 'common/querySupplierList',
            method: 'get'
        })
